...
thumbnail-img: https://img.youtube.com/vi/vKD8y0sMkXs/maxresdefault.jpg
...
<p align="center">
  <a href="https://youtu.be/vKD8y0sMkXs?si=KsaQjt3a8gqycvny" target="_blank" rel="noopener">
...
<div style="max-width: 800px; margin: 1.5rem auto;">
  <iframe width="560" height="315" style="width: 100%; max-width: 100%; aspect-ratio: 16 / 9; height: auto; min-height: 240px;" src="https://www.youtube.com/embed/vKD8y0sMkXs?si=KsaQjt3a8gqycvny" title="PC screen on ESP32-S3 watch" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
</div>
...
If you build this or extend it (UI, audio, protocols), I’m curious what you come up with—leave a comment here or on the [YouTube video](https://youtu.be/vKD8y0sMkXs?si=KsaQjt3a8gqycvny).
